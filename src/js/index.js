(function() {
  ...
  $("#menu-table").on("click", () => {
    ...
    $("#data-json").toggle();
    $(".nav-container-2 button").toggle();
    $("tr:nth-of-type(n+22)").hide();
  ...
  let pagination = e => {
    ...
    $("#data-json")
      ...
      .each(function(index) {
        ...
        if (index % 20 === 0) {
          counter = counter + 1;
          pages += "<span><a href=\"#\">" + counter + "</a></span>";
          $("#pagination-container").html(pages);
        }
      });
    console.log(sumElem / 20);
    console.log(counter);
  };
  /* **************************** */
})();
